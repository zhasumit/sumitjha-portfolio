    ...
    return (
        <section className="w-full flex flex-col lg:flex-row items-center justify-center lg:justify-start mt-14 sm:mt-12 md:mt-16 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12">
            ...
            <div className="w-full text-center lg:text-left order-2 lg:order-none">
                ...
                <div className="text-lg lg:text-xl xl:text-xl mt-3 xs:mt-4 sm:mt-6 md:mt-8 lg:mt-6 px-2 xs:px-4 sm:px-6 md:px-8 lg:px-0 leading-relaxed md:leading-normal text-base-content">
                ...
                <div className="flex justify-center lg:justify-start items-center my-4 gap-1 xs:gap-1.5 sm:gap-2">
                    <PiHouseLineDuotone
                        size={16}
                        className="w-6 h-6 xl:w-6 xl:h-6 text-primary flex-shrink-0"
                    />
                    <span className="text-base lg:text-base xl:text-lg text-base-content mt-1">
